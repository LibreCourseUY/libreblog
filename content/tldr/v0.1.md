...
From centering a div to full fledged animations, this Saturday we will start learning **React**, a **JavaScript** Framework, but we wont be using J\*vaScript, we will use **TypeScript**, like the modern devs we are! 
